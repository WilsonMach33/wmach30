...
function writeFact(){
  ...
  newP.innerHTML = "5! = " + fact(5);

  const body = document.getElementById("hello");
  body.appendChild(newP);
}

var buttonFact = document.getElementById("printFact");
buttonFact.addEventListener('click', writeFact);

// print fib button 
function writeFib(){
  const newP = document.createElement("p");
  newP.innerHTML = "fib(5) = " + fib(5);
  
  const body = document.getElementById("hello");
  body.appendChild(newP);
}

var buttonFib = document.getElementById("printFib");
buttonFib.addEventListener('click', writeFib);

// print GCD button
function writeGCD(){
  const newP = document.createElement("p");
  newP.innerHTML = "gcd(16,32) = " + gcd(16,32);
  
  const body = document.getElementById("hello");
  body.appendChild(newP);
}

var buttonGCD = document.getElementById("printGCD");
buttonGCD.addEventListener('click', writeGCD);
